...
# Write a function named `home` which returns 'Welcome to the Babak's To-Do API Service',
# and assign to the static route of ('/')
@app.route('/')
def home():
    return "Welcome to Babak's To-Do API Service"
