...
- Run four `alpine` containers with interactive shell, in detached mode, name the containers as `mycont1`, `mycont2`, `mycont3`, and `mycont4`, and adda  command to run Alpine shell. Here, 1st and 2nd containers should be in `mynet`, 3rd container should be in default network bridge, 4th container should be in both `mynet` and default network bridge.
